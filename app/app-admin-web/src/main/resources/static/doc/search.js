...
api[0].list[0].list.push({
    order: '1',
    deprecated: 'false',
    url: 'https://dev.gateway.api.asialjim.cn/api/admin/app/app/list',
    methodId: 'f3664c8c70ff5f158ce12d5b2231bb39',
    desc: 'list',
});
api[0].list[0].list.push({
    order: '2',
    deprecated: 'false',
    url: 'https://dev.gateway.api.asialjim.cn/api/admin/app/app',
...
api[0].list[1].list.push({
    order: '1',
    deprecated: 'false',
    url: 'https://dev.gateway.api.asialjim.cn/api/admin/app/chl-app/list/{appid}',
    methodId: 'b9ffaab6cb4f9ede5b2d353165dbef51',
    desc: 'list',
});
