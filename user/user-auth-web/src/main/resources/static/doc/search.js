...
api[0].list[0].list.push({
    order: '1',
    deprecated: 'false',
    url: 'https://dev.gateway.api.asialjim.cn/api/open/user/auth/login',
    methodId: '6005f6a67e86639be123c740ded34664',
    desc: '登录',
});
api[0].list[0].list.push({
    order: '2',
    deprecated: 'false',
    url: 'https://dev.gateway.api.asialjim.cn/api/open/user/auth/auth',
    methodId: '42a9921300f3c28a07b2322f6a6ec121',
    desc: '身份验证',
});
api[0].list[0].list.push({
    order: '3',
    deprecated: 'false',
    url: 'https://dev.gateway.api.asialjim.cn/api/open/user/auth/logout',
    methodId: '1edaa879aba067d05a58422db6d04132',
    desc: '注销',
});
