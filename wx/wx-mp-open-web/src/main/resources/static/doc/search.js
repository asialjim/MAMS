...
api[0].list[0].list.push({
    order: '1',
    deprecated: 'false',
    url: 'https://dev.gateway.api.asialjim.cn/api/open/wx/mp/{appid}/msg/callback',
    methodId: '49b539110a4990563d8593daa33901bd',
    desc: 'get',
});
api[0].list[0].list.push({
    order: '2',
    deprecated: 'false',
    url: 'https://dev.gateway.api.asialjim.cn/api/open/wx/mp/{appid}/msg/callback',
    methodId: '0532fdc04940a6d3b7722027efe8eb53',
    desc: 'post',
});
api[0].list.push({
...
api[0].list[1].list.push({
    order: '1',
    deprecated: 'false',
    url: 'https://dev.gateway.api.asialjim.cn/api/open/wx/mp/{appid}/oauth/page/{handler}',
    methodId: '1524548a468a594e56c3cfed57d3413d',
    desc: 'handle',
});
