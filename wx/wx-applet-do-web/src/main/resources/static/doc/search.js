...
api[0].list.push({
    alias: 'WxAppletUserInfoController',
    order: '18',
    link: '微信小程序用户信息api',
    desc: '微信小程序用户信息API',
    list: []
...
api[0].list[0].list.push({
    order: '1',
    deprecated: 'false',
    url: 'https://dev.gateway.api.asialjim.cn/api/domain/wx/applet/wx/applet/user/phone/number/pure',
    methodId: '0f48c5332afe498c9da9e04bfb51fb4e',
    desc: 'userPurePhoneNumber',
});
api[0].list[0].list.push({
    order: '2',
    deprecated: 'false',
    url: 'https://dev.gateway.api.asialjim.cn/api/domain/wx/applet/wx/applet/user/login',
    methodId: 'eec0ca1034a034f5aa9cd8ff4084fa19',
    desc: 'login',
});
